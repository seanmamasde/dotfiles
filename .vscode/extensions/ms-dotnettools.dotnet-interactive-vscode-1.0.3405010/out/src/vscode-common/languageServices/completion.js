...
function provideCompletion(clientMapper, language, documentUri, documentText, position, languageServiceDelay, token) {
    return (0, utilities_1.debounceAndReject)(`completion-${documentUri.toString()}`, languageServiceDelay, () => __awaiter(this, void 0, void 0, function* () {
        ...
        const completion = yield client.completion(language, documentText, position.line, position.character, token);
        return completion;
    }));
}
