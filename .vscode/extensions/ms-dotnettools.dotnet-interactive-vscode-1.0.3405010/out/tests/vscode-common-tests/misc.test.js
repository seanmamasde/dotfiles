...
describe('Miscellaneous tests', () => {
    describe('.NET notebook detection', () => {
        it('.NET notebook is detected by kernelspec', () => {
            ...
            (0, chai_1.expect)((0, ipynbUtilities_1.isDotNetNotebookMetadata)(metadata)).is.true;
        });
        ...
        it('non-.NET notebook is not detected by kernelspec', () => {
            ...
            (0, chai_1.expect)((0, ipynbUtilities_1.isDotNetNotebookMetadata)(metadata)).is.false;
        });
    ...
    describe('.ipynb helpers', () => {
        it('file extension of .ipynb matches', () => {
            (0, chai_1.expect)((0, ipynbUtilities_1.isIpynbFile)('notebook.ipynb')).to.be.true;
            (0, chai_1.expect)((0, ipynbUtilities_1.isIpynbFile)('NOTEBOOK.IPYNB')).to.be.true;
        });
        it(`file extension of .dib doesn't match`, () => {
            (0, chai_1.expect)((0, ipynbUtilities_1.isIpynbFile)('notebook.dib')).to.be.false;
            (0, chai_1.expect)((0, ipynbUtilities_1.isIpynbFile)('notebook.dotnet-interactive')).to.be.false;
        });
    });
});
