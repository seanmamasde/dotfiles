...
class CompositeKernel extends kernel_1.Kernel {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (let kernel of this._childKernels) {
                if (kernel.supportsCommand(invocation.commandEnvelope.commandType)) {
                    yield kernel.handleCommand({ command: {}, commandType: contracts.RequestKernelInfoType });
                }
            }
        });
    }
    add(kernel, aliases) {
        ...
        kernel.kernelEvents.subscribe({
            next: (event) => {
                event; //?
                (0, connection_1.tryAddUriToRoutingSlip)(event, (0, kernel_1.getKernelUri)(this));
                event; //?
    ...
    handleCommand(commandEnvelope) {
        ...
        if (kernel === this) {
            ...
            (0, connection_1.tryAddUriToRoutingSlip)(commandEnvelope, (0, kernel_1.getKernelUri)(kernel));
